...
// SD 卡支持
  ...
  // SD Card Sorting options
    ...
    #define SDCARD_SORT_CHRONOLOGICAL
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_ALERT_BEEPS         5  // 需要响应时播放的警报哔哔声的数量。
 ...
 */
  ...
  #define Z10_HYBRID_THRESHOLD      10
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define IMPROVE_HOMING_RELIABILITY  // 提高复位的可靠性
  #endif
...
#define PHOTO_GCODE
  ...
  // #define PHOTO_POSITION { /*X_MAX_POS - */2, Y_MAX_POS, 0 }  // { xpos, ypos, zraise } (M240 X Y Z)
  #define PHOTO_DELAY_MS   100                            // (ms) Duration to pause before moving back (M240 P)
  // #define PHOTO_RETRACT_MM   3                          // (mm) E retract/recover for the photo move (M240 R S)
